            ...
            <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;max-height:600px;height:600px;">
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset('img/home/slider/slider_'.$i.'.jpg') }}" alt="Home {{ $i }}" data-bgposition="center" data-bgfit="cover" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption brad-heading sfb tp-resizeme" data-x="25" data-y="center" data-voffset="-70" data-speed="500" data-start="500" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap; color: #FFF;">
                            SAMARETE
                        </div>
                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption brad-sub-heading sfb tp-resizeme" data-x="25" data-y="center" data-voffset="20" data-speed="500" data-start="1000" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap; color: #FFF;">
                        ...
                        <div class="tp-caption brad-buttons sfb tp-resizeme" data-x="18" data-y="center" data-voffset="105" data-speed="500" data-start="1500" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" style="z-index: 7; max-width: auto; max-height: auto; white-space: nowrap;">
                            <a href="/associazioni" class="button button_large">Chi siamo</a><a href="/richieste/new" class="button button_large button_color_grey">Chiedi aiuto</a>
                        </div>
                    </li>
                    @endfor
                </ul>
                            ...
                            <div id="portfolio_929218575" class="portfolio padding-no">
                                <div class="row-fluid portfolio-items bg-style-white sortable-items portfolio-style1 columns-2 love-it-no enable-hr-no hr-type-tiny hr-color-light hr-style-normal element-padding-no info-style-left element-vpadding-default info-onhover-yes " data-columns="2" data-animation-delay="0" data-animation-effect="" data-masonry-layout="no" style="opacity: 1; position: relative; height: 1081.59px;">
                                    <div class="portfolio-item span scheme-default">
                                        <div class="inner-content">
                                            <div class="image hoverlay">
                                                <a href="/associazioni" target="_self"><img class="" src="{{ asset('img/home/box/box_associazioni.jpg') }}" alt="Associazioni"></a>
                                                <div class="overlay">
                                    ...
                                    <div class="portfolio-item span scheme-default">
                                        <div class="inner-content">
                                            <div class="image hoverlay">
                                                <a href="/eventi" target="_self"><img class="" src="{{ asset('img/home/box/box_eventi.jpg') }}" alt="Eventi"></a>
                                                <div class="overlay">
                                    ...
                                    <div class="portfolio-item span scheme-default">
                                        <div class="inner-content">
                                            <div class="image hoverlay">
                                                <a href="/progetti" target="_self"><img class="" src="{{ asset('img/home/box/box_progetti.jpg') }}" alt="Progetti"></a>
                                                <div class="overlay">
                                    ...
                                    <div class="portfolio-item span scheme-default">
                                        <div class="inner-content">
                                            <div class="image hoverlay">
                                                <a href="/servizi" target="_self"><img class="" src="{{ asset('img/home/box/box_servizi.jpg') }}" alt="Servizi"></a>
                                                <div class="overlay">
